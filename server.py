...
@log_class
class Server(threading.Thread, MessageHandle, metaclass=ServerMaker):
    port = Port()
...
def main():
    ...
    params = add_default_in_arg_parser({'-p': config['SETTINGS']['Default_port'], '-a': config['SETTINGS']['Listen_Address']})
