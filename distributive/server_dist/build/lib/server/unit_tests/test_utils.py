...
class TestMessageClass(unittest.TestCase):
    ...
    def test_send_message(self):
        ...
        self.msg.send_message(test_socket, self.test_dict_send)
        ...
        # дополнительно, проверим генерацию исключения, при не словаре на входе.
        self.assertRaises(NonDictInputError, self.msg.send_message, test_socket, 'Это явно не словарь')
    ...
    def test_get_message(self):
        ...
        self.assertEqual(self.msg.get_message(test_sock_ok), self.test_dict_recv_ok)
        # тест корректной расшифровки ошибочного словаря
        self.assertEqual(self.msg.get_message(test_sock_err), self.test_dict_recv_err)
